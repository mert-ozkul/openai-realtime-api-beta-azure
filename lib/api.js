...
export class RealtimeAPI extends RealtimeEventHandler {
   ...
   *   url?: string,
   *   apiKey?: string,
   *   azureOpenAIResourceEndpoint?: string,
  ...
  constructor({
    url,
    apiKey,
    azureOpenAIResourceEndpoint,
    azureOpenAIDeployment,
    dangerouslyAllowAPIKeyInBrowser,
    debug
  } = {}) {
    super();
    this.defaultUrl = `wss://${azureOpenAIResourceEndpoint}/openai/realtime?api-version=2024-10-01-preview&deployment=${azureOpenAIDeployment}`;
